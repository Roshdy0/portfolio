                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    <div className="about-image-wrapper lg:w-1/3 flex justify-center">
                        <div className="avatar-container">
                            <Image src={myImage} alt="Roshdy_Mammdouh_Frontend_React_NextJS" className="avatar-img" priority />
                    ...
                    <div className="about-content lg:w-2/3">
                        ...
                        <p className="bio-text">
                            I am a passionate Frontend Developer with over 3 years of experience specializing in building high-performance, scalable web applications. My expertise lies in <strong className="text-purple-400">Next.js</strong> and <strong className="text-blue-400">React</strong>, where I transform complex problems into seamless, intuitive user experiences. I write clean, maintainable code and always stay updated with the latest UI/UX trends.
                        </p>
