  ...
  const projects = [
    {
      ...
      description:
        "Responsive landing page showcasing the history of ancient Egyptian tourism. Features a sleek dark-themed UI.",
    ...
    },
    {
      ...
      description:
        "A comprehensive barber shop landing page featuring dynamic carousels, service pricing, and a fully responsive layout with a dark theme.",
    ...
    },
    {
      ...
      description:
        "A professional-grade calculator featuring advanced mathematical logic and a fully responsive interface across all devices.",
    ...
    },
    {
      ...
      description:
        "Professional Admin Dashboard featuring a modern Glassmorphism UI and interactive Chart.js analytics. Built with clean HTML5/CSS3 architecture, fully responsive.",
    ...
    },
    {
      ...
      description:
        "A streamlined task management app featuring persistent local storage and dynamic UI updates. user-centric interface for efficient daily productivity.",
    ...
    },
    {
      ...
      description:
        "A high-fidelity gaming landing page featuring a cinematic theme, optimized for performance and immersive user experience.",
            ...
            <div key={index} className="project-card group">
              <div className="project-image-container">
                ...
                <div className="project-links">
                  ...
                  <Link href={project.demo} target="_blank" className="icon-link demo-btn" rel="noopener noreferrer">
